...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VAR = 6,                        /* VAR  */
  YYSYMBOL_EQL = 7,                        /* EQL  */
  YYSYMBOL_OPEN_PAREN = 8,                 /* OPEN_PAREN  */
  YYSYMBOL_CLOSE_PAREN = 9,                /* CLOSE_PAREN  */
  YYSYMBOL_ADD = 10,                       /* ADD  */
  YYSYMBOL_SUB = 11,                       /* SUB  */
  ...
  YYSYMBOL_GT = 15,                        /* GT  */
  YYSYMBOL_LT = 16,                        /* LT  */
  YYSYMBOL_OPEN_BRACKET = 17,              /* OPEN_BRACKET  */
  YYSYMBOL_CLOSE_BRACKET = 18,             /* CLOSE_BRACKET  */
  YYSYMBOL_SEMI_COLON = 19,                /* SEMI_COLON  */
  YYSYMBOL_NL = 20,                        /* NL  */
